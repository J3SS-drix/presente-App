...
const DOM = {
    ...
    selectorReporte:document.getElementById("selector-reporte"),
    infoReporte:document.getElementById("info-reporte"),
    btnPdfReporte:document.getElementById("btn-pdf-reporte"),
...
if(DOM.selectorReporte){

    DOM.selectorReporte.addEventListener(
        "change",
        (e) => {
...
if(DOM.btnPdfReporte){

    DOM.btnPdfReporte.addEventListener(
        "click",
        () => {

            const id =
            DOM.selectorReporte.value;
            ...
            if(DOM.printClassName)
                DOM.printClassName.textContent =
                aula.nombre;

            if(DOM.printSubjectName)
                DOM.printSubjectName.textContent =
                aula.materia;

            if(DOM.printDate)
                DOM.printDate.textContent =
                new Date()
